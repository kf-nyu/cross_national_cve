#!/usr/bin/env python3
"""
Analyze Japan-related vs Non-Japan-related CVEs (All Years)
Three categories: exploited_kev, has_indicators, not_exploited

Adapted from analyze_jp_vs_nonjp_2021_2025_three_categories.py to work with full history.
"""
...
def main():
    ...
    cve_csv_file = project_root / 'results' / 'cve_features_all.csv'
    ...
    print("=" * 80)
    print("JAPAN vs NON-JAPAN CVEs ANALYSIS (ALL TIME)")
    ...
    output_file = results_dir / 'jp_vs_nonjp_all_years.json'
    ...
    # Save CSV
    csv_file = results_dir / 'jp_vs_nonjp_all_years.csv'
